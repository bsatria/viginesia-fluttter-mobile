...
class _MainScreensState extends State<MainScreens> {
  ...
  Future<dynamic> sendMotivasi(String isi) async {
    ...
    debugPrint('bgsdd: $body');
    debugPrint('lu siapa ?: $widget');
    try {
      Response response = await dio.post(
          "$baseurl/Restserver/api/dev/POSTmotivasi",
          data: body,
          options: Options(
  ...
  Future<List<MotivasiModel>> getData() async {
    var response = await dio
        .get('$baseurl/Restserver/api/Get_motivasi?iduser=${widget.idUser}');
    print(" ${response.data}");
  ...
  Future<dynamic> deletePost(String id) async {
    ...
    var response = await dio.delete(
        '$baseurl/Restserver/api/dev/DELETEmotivasi',
        data: data,
        options: Options(
            contentType: Headers.formUrlEncodedContentType,
  ...
  Future<List<MotivasiModel>> getData2() async {
    var response = await dio.get('$baseurl/Restserver/api/Get_motivasi');
    print(" ${response.data}");
    if (response.statusCode == 200) {
      var getUsersData = response.data as List;
      var listUsers =
